    ...
    <section className="text-white py-10 lg:py-15">
      <div className="grid grid-cols-2 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          I am  dedicated to building efficient, responsive, and scalable web applications.
          </p>
          <div>
            ...
            <button
              className="bg-transparent text-white w-full sm:w-auto rounded-full 
            bg-gradient-to-r from-blue-500 via-purple-500 to-pink-800 
            border border-white px-1 py-1"
              onClick={() => window.open("/simran_cv.pdf", "_blank")} // Use the path or external link to the PDF
            >
              <span className="block bg-[#121212] border rounded-full py-2 px-5 hover:bg-slate-800">
                Download CV
              </span>
            </button>
          </div>
