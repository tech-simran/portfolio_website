      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-12 px-6 xl:gap-20 bg-[#121212]">
        ...
        <div className="mt-8 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg text-gray-300 leading-relaxed">
            I am a full-stack developer skilled in React, Redux, Next.js,
            MongoDB, Node.js, and JavaScript. I create dynamic, responsive web
            applications with a focus on performance and user experience. My
            passion lies in developing both frontend and backend solutions that
